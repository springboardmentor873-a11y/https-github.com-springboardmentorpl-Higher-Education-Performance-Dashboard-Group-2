...
# 1. Data Ingestion
qs = pd.read_csv('module_01/2026 QS World University Rankings.csv')
the = pd.read_csv('module_01/THE World University Rankings 2016-2026.csv')
...
merged_data.to_csv('module_01/university_raw_data.csv', index=False)
